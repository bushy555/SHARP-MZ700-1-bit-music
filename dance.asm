...
;
; Assemble wit SJASMPLUS.	
; VZ		sjasmplus %1.asm
;		rbinary %1.obj %1.vz
; Use: VZEM.  File--> Open
;
; SHARP MZ700   sjasmplus %1.asm
; Use MZ700-Emu --> debugger    
; n dance.bin
; l5000
; g
; <ESC> q
; J5000
;
; MICROBEE	sjasmplus %1.asm
; Use: wasp, Mame.   Load --> .COM file at $100.
;
; ZX		sjasmplus %1.asm
; use: fuse.
;
...
.lb7
	...
	and	8		; Sharp MZ700		; 4+4+4 + 4+4+7=27t
;	and 	16 		; ZX
;	and 	32 		; VZ
;	and	64		; MIcrobee
