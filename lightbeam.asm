...
;
;
; MZ700 port by bushy555.  Sounds ok.     25/may/2026.
;
...
CheckKeyboard:
	jp	  CoreLoopPart2	; 10t => 11+4+7 + 4+4+11+4+7+4+12 = 68t
...
InitCounters1:
	ld	h,  8;m33			; H=24 for sound,  H=0 for mute
PauseChannel1:
