...
;	push	af
	...
	ld 	hl, $d000+200;  160+96	; CLEAR Equaliser SCREEN
	ld	b, 64			; to a dark green background
l0:	ld	(hl), 0
	inc	hl
	ld	(hl), 0
	inc	hl
	...
	ld 	hl, $d000+800+2 ; 160+12+320		; Do  reg A
	ld	c, a
...
;	ld	(hl), 255
	ld	de, 65496		; sub 32, by adding 65536-32-3pixels
...
;	srl	a
	inc	a
	ld	b, a
	ld 	hl, $d000+800+10 ; 160+16+320
l3:	ld	(hl), 255;159+16 ;c			;159
;	inc	hl
;	ld	(hl), 255
;	ld	de, 65495 	
	add 	hl, de
...
;	srl	a
	...
	inc	a
	ld	b, a
	ld 	hl, $d000+800+14 ; 160+4+320
l4:	ld	(hl), 255 ;159+32;c
;	inc	hl
;	ld	(hl), 255;c
	ld	de, 65496
	add 	hl, de
